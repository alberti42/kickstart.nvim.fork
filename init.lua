...
require('lazy').setup({
  ...
  -- This plugin provides easy keybindings for toggling line and block comments.
  -- Instead of manually typing comment characters, you can:
  --   - `gcc` to toggle a comment on the current line
  --   - `gc` + {motion} to toggle comments over a text object or movement (e.g., `gcw`, `gc}`)
  --   - In visual mode: `gc` to comment/uncomment the selection
  -- It respects the current filetype, so the right comment syntax (`--`, `//`, `#`, etc.) is used automatically.
  -- This keeps commenting fast, consistent, and language-aware.
  {
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    dependencies = {
      ...
      -- Add the recent-files extension
